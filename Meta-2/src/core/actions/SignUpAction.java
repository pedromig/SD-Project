	...
	public String execute() {
		if (!(name.equals("") || name.contains(":") || name.contains("|") ||
			...
			try {
				...
				switch (personType) {
					case STUDENT:
						person = new Student(name, password, address, faculty, department, phoneNumber,
								identityCardNumber, gregDate);
						break;
					case TEACHER:
						person = new Teacher(name, password, address, faculty, department, phoneNumber,
								identityCardNumber, gregDate);
						break;
					case EMPLOYEE:
						person = new Employee(name, password, address, faculty, department, phoneNumber,
								identityCardNumber, gregDate);
						break;
				}
