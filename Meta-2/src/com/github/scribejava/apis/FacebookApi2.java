...
public class FacebookApi2 extends DefaultApi20 {
	...
	private static final String AUTHORIZE_URL = "https://www.facebook.com/v2" +
												".2/dialog/oauth?client_id=%s&redirect_uri=%s";
	...
	public AccessTokenExtractor getAccessTokenExtractor() {
		return response -> {
			Preconditions.checkEmptyString(response, "Response body is incorrect. Can't extract a token from an " +
													 "empty string");
			try {
